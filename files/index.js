...
const UUID = process.env.UUID || '12c00008-e2c0-4290-956e-c7557f5079b7'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'chore-huanthree.fastfish.pp.ua';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiZDJmNmY4YmYwYzhlZjkyNDg4MmIxNjEyODYwODQ4ODciLCJ0IjoiMjZkZTc2MzMtYmI4YS00OGIzLWJhMDUtZTBjM2Q0NzM4MDRkIiwicyI6Ik5EUXpNamc0T1dFdE1USTVZeTAwT1RCa0xXSTRaV010WlRkaFlUWmpNekF3WTJNNSJ9';
const CFIP = process.env.CFIP || 'www.visa.com.tw';
const NAME = process.env.NAME || 'Choreo-huanthree';
